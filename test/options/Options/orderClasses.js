describe('orderClasses option', function() {
	...
	describe('Check the defaults', function() {
		...
		it('Applied to single column', function() {
			...
			expect($('#example tbody tr:eq(0) td:eq(3)').attr('class')).toBe('dt-type-numeric');
			expect($('#example tbody tr:eq(0) td:eq(4)').attr('class')).toBe('dt-type-date');
			expect($('#example tbody tr:eq(0) td:eq(5)').attr('class')).toBe('dt-type-numeric');
		});
