 ...
 * In contrary to ssp.class.php this one uses the MySQLi driver and not PDO
 *
...
class SSP {
     ...
     * Database connection
     *
     * Obtain an PHP MySQLi connection from a connection details array
     *
     ...
     *  @param  array $request Data sent to server by DataTables
     *  @param  array $columns Column information array
     *  @param  array $bindings Array of values for MySQLi bindings, used in the
     *    sql_exec() function
            ...
            for ( $i=0, $ien=count($request['columns']) ; $i<$ien ; $i++ ) {
                ...
                if ( $requestColumn['searchable'] == 'true' ) {
                    if(!empty($column['db'])){
                        ...
                        $globalSearch[] = "`".$column['db']."` RLIKE ".$binding;
                    }
                }
            }
        }
     ...
     *
     *  @param  array $request Data sent to server by DataTables
     *  @param  array|MySQLi $conn MySQLi connection resource or connection parameters array
     ...
     * @param  array    $bindings Array of MySQLi binding values from bind() to be
    ...
    static function sql_exec ( $db, $bindings, $sql=null )
    {
        ...
        if ( is_array( $bindings ) ) {
            ...
            for ( $i=0, $ien=count($bindings) ; $i<$ien ; $i++ ) {
                ...
                $bindingValues[] = $binding['val'];
            }

            if (!empty($bindingTypes))
    ...
    /**
     * Create a MySQLi binding which can be used for escaping variables safely
     * when executing a query with sql_exec()
     *
     * @param  array &$a    Array of bindings
     * @param  *      $val  Value to bind
     * @param  string    $type MySQLi field type
