...
$versions = json_decode(
	is_file('/tmp/dt-versions')
		...
		: file_get_contents_curl('https://api.datatables.net/versions/release'),
	true
);
...
DT_Example::$lookup_libraries['js' ]['bootstrap5']   = 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.3/js/bootstrap.bundle.min.js';
DT_Example::$lookup_libraries['css']['bootstrap5']   = 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.3/css/bootstrap.min.css';
DT_Example::$lookup_libraries['css']['bulma']        = 'https://cdnjs.cloudflare.com/ajax/libs/bulma/1.0.3/css/bulma.min.css';
...
DT_Example::$lookup_libraries['js' ]['semanticui']   = 'https://cdnjs.cloudflare.com/ajax/libs/fomantic-ui/2.9.2/semantic.min.js';
...
DT_Example::$lookup_libraries['js']['pdfmake']       = 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/pdfmake.min.js';
DT_Example::$lookup_libraries['js']['vfsfonts']      = 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js';
